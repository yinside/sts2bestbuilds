...
export async function generateStaticParams() {
  return getPostsByType('guide').map((post) => ({ slug: post.slug }));
}
      ...
      <article>
        <div className="bg-[var(--bg-elevated)] border-b border-[var(--border)]">
          <div className="container-site py-10 md:py-14">
            <Link href="/guides" className="inline-flex items-center gap-1 text-sm text-[var(--text-muted)] hover:text-white transition-colors mb-6">
